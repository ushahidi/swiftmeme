...
class Controller_Api_ContentSelection extends Controller
{
    ...
    // Does filtering additionaly by tags also

    public function action_getbytags($state, $minVeracity, $maxVeracity, $type, $subType, $source, $pageSize, $pageStart, $orderBy, $tags)
    {
        $params = array();
