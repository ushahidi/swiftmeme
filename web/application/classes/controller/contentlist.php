...
class Controller_ContentList extends Controller_Template_Master
{
    ...
    public function action_get($state)
    {
        ...
        $this->set_content();
        $this->set_left_content();
        $this->set_right_content();
    ...
    private function set_left_content()
    {
        $this->template->content_left = new View("parts/leftcontent");
    }
    ...
    private function set_right_content()
    {
        $this->template->content_right = new View("parts/rightcontent");
    }
} 
